                                 ...
                                 int nIterations, bool* pbStopFlag, const unsigned long nLoopKF, const bool bRobust)
{
    ...
    std::unique_ptr<g2o::BlockSolver_6_3::LinearSolverType> linearSolverUniq(linearSolver);

    std::unique_ptr<g2o::BlockSolver_6_3> solver_ptr (new g2o::BlockSolver_6_3(std::move(linearSolverUniq)));
